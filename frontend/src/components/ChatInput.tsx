...
export type ChatMode = 'chat' | 'web' | 'pdf' | 'ask';
    ...
    <div className="composer-wrap">
      ...
      <div className="composer">
        ...
        <div className="composer__tools">
          <div>
            <button aria-label="Adjuntar archivo" disabled={disabled}>
              <Paperclip size={17} />
            </button>
            <button aria-label="Ajustes de respuesta" disabled={disabled}>
      ...
      <p className="composer-note">
        Orion puede cometer errores. Verifica la información importante.
      </p>
    </div>
  );
}
